...
<head>
    <meta charset="UTF-8">
    <title>Danh Mục - Thuê Nội Thất</title>
    ...
    <div class="row text-center">
        <c:forEach var="dm" items="${danhMucList}">
            <div class="col-6 col-md-4 col-lg-3 mb-4">
                <a href="${pageContext.request.contextPath}/sanpham-vanglai?ma_danh_muc=${dm.maDanhMuc}" class="text-decoration-none text-dark">
                    <img src="${pageContext.request.contextPath}/${dm.urlAnh}" class="img-fluid w-50 mx-auto d-block mb-2"
                         alt="${dm.ten}" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/assets/img/default.png';">
                    <div>${dm.ten}</div>
                </a>
            </div>
        </c:forEach>
